...
const page = () => {
  return (
    <header className="sticky top-0 z-20 flex items-start justify-between p-5 mx-auto max-w-7xl xl:items-center bg-[rgb(36,36,36)]">
      ...
      >
        <SocialIcon
          url="https://www.facebook.com/Kian.Murllo/"
          fgColor="gray"
          bgColor="transparent"
          target="{_blank}"
        />
        <SocialIcon
          url="https://www.instagram.com/kian.mrllo/"
          fgColor="gray"
          bgColor="transparent"
          target="{_blank}"
        />
        <SocialIcon
          url="https://twitter.com/Kian_Murillo"
          fgColor="gray"
          bgColor="transparent"
          target="{_blank}"
        />
        <SocialIcon
          url="https://www.linkedin.com/in/kian-murillo-623510165/"
          fgColor="gray"
          bgColor="transparent"
          target="{_blank}"
        />
        <SocialIcon
          url="https://github.com/KianM-23"
          fgColor="gray"
          bgColor="transparent"
          target="{_blank}"
        />
